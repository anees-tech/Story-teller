            ...
            <div className="w-full lg:w-1/2">
              <div className="lg:max-w-lg">
                ...
                <p className="mt-3 text-gray-600 dark:text-gray-400">
                  Welcome to our enchanting candle emporium, where flickering flames meet artistic craftsmanship. Immerse yourself in the warm glow of our thoughtfully curated collection, each candle telling Link unique story through scents and designs. From soothing lavender to invigorating citrus, our hand-poured creations are designed to elevate every moment, turning ordinary spaces into extraordinary sanctuaries. Welcome to Link world where ambiance meets artistry, and every candle illuminates Link moment of serenity.
                </p>
